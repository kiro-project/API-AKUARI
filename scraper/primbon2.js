...
const originalCode = '(adsbygoogle = window.adsbygoogle || []).push({});';
    ...
    return new Promise((resolve, reject) => {
        axios
            ...
            .then(({
              ...
              const originalCode = '(adsbygoogle = window.adsbygoogle || []).push({});';
const replacementCode = ''; // Replace with your desired code or an empty string to remove it
const resultt = isi.replace(new RegExp(escapeRegExp(originalCode), 'g'), replacementCode);
...
const isii = hasil.replace(new RegExp(escapeRegExp(originalCode), 'g'), replacementCode);
    ...
    return new Promise((resolve, reject) => {
        ...
        axios
            ...
            .then(({
              ...
              const isi = result.replace(new RegExp(escapeRegExp(originalCode), 'g'), replacementCode);
    ...
    return new Promise((resolve, reject) => {
        ...
        request(options, function (error, response, body) {
            ...
            const res = $('#body').text().replace(/^\s*\n/gm, "").replace("Hari Lahir:", "\nHari Lahir:").replace("Seseorang", "\nSeseorang").replace("Fluktuasi", "\n\nFluktuasi").replace("Hover\n", "").replace(/< Hitung Kembali.*$/s, "")
                 const isi = res.replace(new RegExp(escapeRegExp(originalCode), 'g'), replacementCode);
